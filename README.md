...
1. Create a folder in `assets/images/projects/` and place the cover and gallery images inside it.
2. Add one object to `assets/data/projects.js`.

The Home cards, Work filters and `project.html?id=project-id` page are generated from that single object. No additional HTML page is needed.
